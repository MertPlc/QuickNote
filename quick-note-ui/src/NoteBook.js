    ...
    return (
        <div className="h-100 d-flex flex-column">
            <Navbar bg="light" expand="lg">
                <Container fluid>
                    <Navbar.Brand>
                        <FontAwesomeIcon icon={["far", "file-alt"]} className="me-1" />
                        QuickNote
                    </Navbar.Brand>
                ...
                <Row className="h-100">
                    <Col sm={4} md={3} className="py-3">
                        ...
                        <ListGroup defaultActiveKey={"#note-0"}>
                            { notes.map((x,i) => (
                                <ListGroup.Item key={i} action href={"#note-" + i} onClick={e => handleListItemClick(e, i)} active={i == selectedIndex}>
                                    {x.title}
                                </ListGroup.Item>
                            ))}
                        </ListGroup>
                    </Col>
                    <Col sm={8} md={9} className={selectedIndex == -1 ? "d-none" : "d-flex flex-column py-3"}>
